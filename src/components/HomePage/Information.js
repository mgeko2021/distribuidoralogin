      ...
      <div className="NetworkInformation col-md-8 p-0">
        <span className="Track ">
          <a href={"https://www.google.com/maps"}>
            <LocalShippingIcon style={{ color: "#51BAFF" }} />
          </a>
          Rastrea mi pedido
        </span>
        <span className="PBX">
          <CallIcon style={{ color: "#51BAFF" }} />
        ...
        <span className="References">
          ...
          <a href={"https://www.instagram.com/distribuidoranegociemos/?hl=es"}>
        ...
        <PopUp trigger={buttonPopUp} setTrigger={setButtonPopUp}>
          <div className="popup-text">
            ...
            <p>
              ...
              sit eveniet molestiae tenetur quam facilis quibusdam distinctio.
              Numquam dolorum placeat rem saepe commodi alias. Nihil labore
              incidunt impedit iste?
            </p>
